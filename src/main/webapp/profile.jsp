                ...
                <div class="ibox float-e-margins">
                    ...
                    <div>
                        <div class="ibox-content no-padding border-left-right">
                            <img alt="image" class="img-responsive" src="img/jason.jpg">
                        </div>
                        <div class="ibox-content profile-content">
                            <h4><strong>Jason Zhang</strong></h4>
                            <p><i class="fa fa-map-marker"></i> zjut一个默默无闻的coder</p>
                            <h5>
                                    关于我
                                </h5>
                            <p>
                                会点前端技术，不是很精；热爱生活，热爱互联网，目前研究方向机器学习与模式识别（machine learning & pattern recognition）在不断的寻求新的突破。
                            </p>
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong>jason</strong> 关注了 <strong>Ben</strong>.
                                        <br>
                                        <small class="text-muted">54分钟前 来自 phone</small>
                                        <div class="actions">
                                ...
                                <div class="feed-element">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong>作家jenson</strong> 发布了一篇文章
                                        <br>
                                ...
                                <div class="feed-element">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong>jason</strong> 开通了github
                                        <br>
                                        <small class="text-muted">今天 09:27 来自   iPhone</small>
                                        <div class="well">
                                                                                    想起师兄说的话，想起往事，美好的事情叫精彩，糟糕的事情叫经历，this is life.项目经验不丰富
                                        </div>
                                ...
                                <div class="feed-element">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong>jason</strong> 关注了 <strong>jason</strong>.
                                        <br>
